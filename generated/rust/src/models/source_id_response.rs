...
/// SourceIdResponse : An object containing information on source IDs. Source IDs refer to underlying IDs from address data sets. Currently supporting UPRN and UDPRN in the UK  referring to the OrdnanceSurvey datasets 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SourceIdResponse {
