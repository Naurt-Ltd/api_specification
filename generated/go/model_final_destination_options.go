...
type FinalDestinationOptions struct {
	...
	SourceId *SourceIdRequest `json:"source_id,omitempty"`
}
...
// SetSourceId gets a reference to the given SourceIdRequest and assigns it to the SourceId field.
